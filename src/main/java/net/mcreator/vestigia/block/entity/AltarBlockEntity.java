...
public class AltarBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AltarBlockEntity(BlockPos position, BlockState state) {
		super(VestigiaModBlockEntities.ALTAR.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new AltarGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
