...
public class GoldenKnightRenderer extends HumanoidMobRenderer<GoldenKnightEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/golden-knight.png");

	public GoldenKnightRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(GoldenKnightEntity entity, HumanoidRenderState state, float partialTicks) {
