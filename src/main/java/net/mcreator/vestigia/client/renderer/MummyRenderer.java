...
public class MummyRenderer extends HumanoidMobRenderer<MummyEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/momie.png");
	...
	@Override
	public void extractRenderState(MummyEntity entity, HumanoidRenderState state, float partialTicks) {
