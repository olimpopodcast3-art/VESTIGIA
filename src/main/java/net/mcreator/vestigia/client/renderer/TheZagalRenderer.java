...
public class TheZagalRenderer extends HumanoidMobRenderer<TheZagalEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/medieval-bandit.png");

	public TheZagalRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(TheZagalEntity entity, HumanoidRenderState state, float partialTicks) {
