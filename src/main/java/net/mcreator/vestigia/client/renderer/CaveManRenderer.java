...
public class CaveManRenderer extends HumanoidMobRenderer<CaveManEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/primitive-man.png");
	...
	@Override
	public void extractRenderState(CaveManEntity entity, HumanoidRenderState state, float partialTicks) {
