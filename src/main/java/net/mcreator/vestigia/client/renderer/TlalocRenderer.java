...
public class TlalocRenderer extends HumanoidMobRenderer<TlalocEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/tlaloc.png");

	public TlalocRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(TlalocEntity entity, HumanoidRenderState state, float partialTicks) {
