...
public class PharaohRenderer extends HumanoidMobRenderer<PharaohEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/pharao.png");
	...
	@Override
	public void extractRenderState(PharaohEntity entity, HumanoidRenderState state, float partialTicks) {
