...
public class PortadorRenderer extends HumanoidMobRenderer<PortadorEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("vestigia:textures/entities/dark_knight.png");

	public PortadorRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(PortadorEntity entity, HumanoidRenderState state, float partialTicks) {
