...
public class PharaohEntity extends Monster {
	public PharaohEntity(EntityType<PharaohEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(VestigiaModItems.UNCHARGED_GOLDEN_STAFF.get()));
		refreshDimensions();
	}
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(Blocks.GOLD_BLOCK));
	}
