...
public class WishGUIMenu extends AbstractContainerMenu implements VestigiaModMenus.MenuAccessor {
	...
	public WishGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VestigiaModMenus.WISH_GUI.get(), id);
