...
public class StellarEmblemGUIMenu extends AbstractContainerMenu implements VestigiaModMenus.MenuAccessor {
	...
	public StellarEmblemGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VestigiaModMenus.STELLAR_EMBLEM_GUI.get(), id);
