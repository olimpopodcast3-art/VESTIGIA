...
public class VestigiaBookGUIMenu extends AbstractContainerMenu implements VestigiaModMenus.MenuAccessor {
	...
	public VestigiaBookGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VestigiaModMenus.VESTIGIA_BOOK_GUI.get(), id);
