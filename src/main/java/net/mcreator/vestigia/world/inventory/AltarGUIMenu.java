...
public class AltarGUIMenu extends AbstractContainerMenu implements VestigiaModMenus.MenuAccessor {
	...
	public AltarGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VestigiaModMenus.ALTAR_GUI.get(), id);
